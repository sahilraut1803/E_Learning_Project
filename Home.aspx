<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="E_Learning_Project.Home" %>
  ...
  <body>
    ...
    <section id="nav-bar">
      <nav class="navbar navbar-expand-lg navbar-light">
       ...
       <img src="Theme/images/webiz-logo.png" />
         </a>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <a href="#" class="link-play">
              <img src="Theme/svg/play.svg" alt="" class="play-btn" />Watch Tutorials
            </a>
          </div>
            <div class="col-md-6">
              <img src="Theme/svg/undraw_email_campaign_qa8y.svg" alt="" class="img-fluid" />
            </div>
        </div>
      </div>
        <!--- Background wave Hero ---->
        <img src="images/ground@-min.png" class="bottom-img" alt="">
                    <img src="Theme/images/ground@-min.png"" class="bottom-img"   alt="" />
      ...
      <div class="container text-center">
        ...
        <div class="row text-center">
          <div class="col-md-4 services">
            <img src="Theme/images/ground@-min.png"" class="service-img"   alt="" />
          ...
          <div class="col-md-4 services">
            <img src="file:///d:\sahil%20{project\e_learning_project\theme\svg\branding.svg" class="service-img" />  
          ...
          <div class="col-md-4 services">
            <img src="file:///d:\sahil%20{project\e_learning_project\theme\svg\ads.svg"   alt="" />
          ...
          <div class="col-md-4 services">
            <img src="file:///d:\sahil%20{project\e_learning_project\theme\svg\undraw_Savings_dwkw.svg" class="service-img"   alt="" />
            <h4>PPC</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
          ...
          <div class="col-md-4 services">
            <img src="file:///d:\sahil%20{project\e_learning_project\theme\svg\social.svg"   alt="" />
            <h4>Social Media</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
          ...
          <div class="col-md-4 services">
          <img src="file:///d:\sahil%20{project\e_learning_project\theme\svg\undraw_wireframing_nxyi.svg" class="service-img"   alt="" />
            <h4>SEO</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 about">
            ...
            <div class="col-md-6">
              <img src="file:///d:\sahil%20{project\e_learning_project\theme\svg\undraw_mobile_marketing_iqbr.svg" class="img-fluid" alt="" />
            </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row offset-1">
          <div class="col-md-5 testimonials">
            ...
            <img src="file:///d:\sahil%20{project\e_learning_project\theme\images\testimonials\testimonial-1.jpg"  alt="" />
...
<img src="file:///d:\sahil%20{project\e_learning_project\theme\images\testimonials\testimonial-3.jpg" />
...
<img src="file:///d:\sahil%20{project\e_learning_project\theme\images\webiz-logo.png" />
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
              </p>
